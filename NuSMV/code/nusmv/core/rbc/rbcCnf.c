                    ...
                    int* literalAssignedToWholeFormula)
{
 ...
 /* check whether maxUnchangedRbcVariable can be extended (or whether
  ...
  case RBC_TSEITIN_CONVERSION:
    /* test */
    printf("The switch choose cnf simple.\n");
  ...
  case RBC_SHERIDAN_CONVERSION:
    /* test */
    printf("The switch choose cnf compact.\n");
  ...
  /* test */
  printf("zhangjiaqi Rbc_Convert2Cnf: result: %d", result);
  return result;
}
...
int Rbc_RbcIndex2CnfVar(Rbc_Manager_t* rbcManager, int rbcIndex)
{
  ...
  /* test */
  printf("zhangjiaqi Rbc_RbcIndex2CnfVar: result: %d\n", var);
  printf("The input element rbcIndex is: %d\n",rbcIndex);
  return var;
}
